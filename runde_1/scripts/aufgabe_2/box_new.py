...
#    print("placed items: (removePrev######################################)")
#    for number in placed:
#        print (findRot(number), end=" ")
#    print("\n",*placed)
#    print("max(unplaced)")#################
    last = placed[-1]
    ...
    unplaced.sort()
    placed.pop(-1)
#    print("prevRot:", prevRot)
    #print("blockCounter:", blockCounter)
#    print("len(unplaced):", len(unplaced))
#    print("last:", last)
#    print("unplaced after modify", unplaced)
#    print("last+1 != max(unplaced):",last+1 != max(unplaced))
...
#        printBox("removePrev")
#        print("last != max(unplaced):",last != max(unplaced))
        a, b = removePrev(justRemove = 1)
        return a, b
...
#for i in range(1000):
#    print(f"which, rot {unplaced[blockCounter], rot}")
#    printBox(f"which, rot {unplaced[blockCounter]+1, rot}")
...
# funktioniert nicht für multiple step backtracking :(
