...
def update_grid():
    for row in range(13):
        for col in range(13):
            canvas.itemconfig(texts[row][col], text=np.round(schulhof[row, col], 3))
...
def get_custom_color(value):
    ...
    red = value*205/20 +150 # Adjust the formula based on your preference
    green = value*205/20 +150
    blue = value * 205/20+150
...
rectangles = [[None] * 13 for _ in range(13)]
texts = [[None] * 13 for _ in range(13)]
